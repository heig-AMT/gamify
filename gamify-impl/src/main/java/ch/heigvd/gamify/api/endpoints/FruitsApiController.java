...
import ch.heigvd.gamify.api.FruitsApi;
import ch.heigvd.gamify.entities.FruitEntity;
import ch.heigvd.gamify.api.model.Fruit;
import ch.heigvd.gamify.repositories.FruitRepository;
...
public class FruitsApiController implements FruitsApi {
  ...
  public ResponseEntity<Void> createFruit(
  ...
  public ResponseEntity<Fruit> getFruit(
    ...
    FruitEntity existingFruitEntity = fruitRepository.findById(Long.valueOf(id))

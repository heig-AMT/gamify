...
public class Rules implements En {
  ...
  public Rules(Environment environment) {
    ...
    When(
        "I create the rule payload {word} with name {word} for category {word} and event type {word}",
        (String named, String name, String category, String type) -> environment.getClient()
            .putPayload(named, namedRule(name, category, type)));
    When(
        "I create the rule payload {word} with name {word} for category {word} and event type {word} awarding {int} points",
        (String named, String name, String category, String type, Integer points) -> environment
            .getClient()
